...
\begin{enumerate}
	...
	\item Mine a few blocks to trigger the synchronization and to have enough ether to be able to commit a few hashes from the start. % TODO: If you use the word ether here, you need to explain it!
\end{enumerate}